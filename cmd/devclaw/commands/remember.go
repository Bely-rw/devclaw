...
// newRememberCmd cria o comando `devclaw remember` para adicionar fatos à memória.
...
Exemplos:
  devclaw remember "I prefer responses in Portuguese"
  devclaw remember "My daily standup is at 9am"`,
